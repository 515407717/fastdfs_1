package com.fastdfs.fastdfs_1.dfs.controller;


import com.fastdfs.fastdfs_1.dfs.config.FileDfsUtil;
...
public class FileController {
    ...
    @RequestMapping(value = "/upload/admin",headers="content-type=multipart/form-data", method = RequestMethod.POST)
